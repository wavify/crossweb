 ...
 */
var _Security = function (method, key, iv) {
  this.method = method;
  try {
    this.key = new Buffer(_Security.hexToBytes(key)).toString('binary');
    this.iv = new Buffer(_Security.hexToBytes(iv)).toString('binary');
  } catch (e) {
    logger.debug (e);
 ...
 */
_Security.hexToBytes = function (hex) {
 ...
 */
_Security.prototype.encrypt = function (data) {
  var output = '';
  try {
 ...
 */
_Security.prototype.decrypt = function (data) {
  var output = '';
  try {
